...
// To use this version:
// 1. Rename this file to index.js (replace the current one)
// 2. Set ANTHROPIC_API_KEY in Vercel environment variables
// 3. Make sure pages/api/generate-meal-plan.js exists
...
export default function MealPlanner() {
  ...
  const generateMealPlan = async (emailReminders = false) => {
    ...
    try {
      ...
      // Call our secure backend API route instead of Gemini API directly
